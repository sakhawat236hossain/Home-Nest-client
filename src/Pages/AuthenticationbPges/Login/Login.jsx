  ...
  return (
    <div className="flex justify-center items-center min-h-screen  p-4">
      <form
        ...
        className=" p-6 sm:p-8 rounded-2xl shadow-md w-full max-w-sm sm:max-w-md"
      >
        ...
        <div className="text-left mb-3">
          <button
            ...
            type="button"
            className="link text-green-600 link-hover text-sm"
          >
            Forgot password?
          </button>
        </div>
        ...
        <div className="flex items-center justify-center mb-4">
          ...
          <span className="mx-2  text-xs sm:text-sm font-medium">
            OR
          </span>
          <span className="border-b border-gray-300 w-1/4"></span>
        </div>
